...
const ShimmerRestaurantList = () => {
    const shimmerCards = Array(5).fill(0); // Assuming 5 shimmer cards

    return (
        <div className="p-6">
            {/* Top Restaurants Title */}
            <ShimmerText line={1} gap={10} variant="primary" className="w-1/4 mb-4" />
            ...
            <div className="flex gap-4 space-x-4 overflow-x-hidden">
                {shimmerCards.map((_, index) => (
                    <div key={index} className="w-60">
                        ...
                        <ShimmerText line={1} gap={10} variant="primary" className="w-3/4 mb-1" />
